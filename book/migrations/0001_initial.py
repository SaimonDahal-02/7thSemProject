# Generated by Django 4.2.1 on 2023-09-13 11:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(blank=True, related_name='book_authors', to='book.author')),
                ('favorites', models.ManyToManyField(blank=True, default=None, related_name='favorite', to='book.userprofile')),
